import('inquirer').then(inquirer => {
  ...
  // Handle any error that occurred during the dynamic import
});
const inquirer = require('inquirer');
const fs = require("fs");
...
`;
  fs.writeFile(`./examples/${result.text}.svg`, fullRender, err => err ? console.log(err) : console.log(`Success! Generated ${result.text}.svg`));
});
